...
const messages = {
  ...
  en: {
    ...
    confirmEmailSend: "Confirm Email Send",
    emailConfirmDialog1: "Are you sure you want to send an email to",
    emailConfirmDialog2: "selected clients?",
    ...
    enterEmailsPlaceholder: "Enter email addresses here",
    emailInstructions: "Enter multiple email addresses separated by commas.",
    add: "Add",
    delete: "Delete",
    emailsAddedSuccess: "Email addresses added successfully!",
    emailsDeletedSuccess: "Selected email addresses deleted successfully!",
  },
  ua: {
    name: "Ім`я",
    password: "Пароль",
