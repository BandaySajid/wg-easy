...
class API {
  ...
  async getClientsEmails() {
    return this.call({
      method: "get",
      path: `/wireguard/emails`,
    });
  }

  async addClientsEmails({ clients }) {
    return this.call({
      method: "post",
      path: `/wireguard/emails`,
      body: { clients },
  ...
  async deleteClientsEmails({ clients }) {
    return this.call({
      method: "delete",
      path: `/wireguard/emails`,
      body: { clients },
  ...
  async sendEmailToClients({ clients, clientId }) {
    return this.call({
      method: "post",
      path: `/wireguard/emails/send`,
