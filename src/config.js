...
module.exports.EMAIL_CLIENT = Number(process.env.EMAIL_CLIENT) || null;
module.exports.SMTP_EMAIL = process.env.SMTP_EMAIL || null;
module.exports.SMTP_PASSWORD = process.env.SMTP_PASSWORD || null;
module.exports.SMTP_USER = process.env.SMTP_USER || null;
module.exports.SMTP_HOST = process.env.SMTP_HOST || null;
module.exports.SMTP_PORT = Number(process.env.SMTP_PORT) || null;
module.exports.SMTP_IS_SECURE = Number(process.env.SMTP_IS_SECURE) || null;
module.exports.EMAIL_SUBJECT = process.env.EMAIL_SUBJECT || null;
module.exports.EMAIL_HTML = process.env.EMAIL_HTML || null;
module.exports.EMAIL_TEXT = process.env.EMAIL_TEXT || null;
